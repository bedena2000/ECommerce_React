    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="h-[250px] bg-[#F5F5F5] rounded-md relative flex flex-col justify-center items-center">
                ...
                <Link onClick={handleCart} to={`/cart`} className="transition-all duration-200 ease-in bg-[#363738] hover:bg-gray-400 w-full text-center absolute bottom-0 h-[41px]">
                ...
                <div onClick={handleRemoveFromWishlist} className="absolute cursor-pointer top-3 right-3 w-[34px] h-[34px] transition-all ease-in duration-100 hover:bg-gray-300 bg-white rounded-full flex justify-center items-center">
